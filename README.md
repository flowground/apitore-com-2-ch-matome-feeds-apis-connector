# ![LOGO](logo.png) 2ch matome feeds APIs MSP Connector

## Description

A generated MSP connector for the 2ch matome feeds APIs API (version 0.0.1).
...
flowground :- Telekom iPaaS / apitore-com-2-ch-matome-feeds-apis-connector<br/>
